...
get_domains() -> gen_server:call(?SERVER, domains).

-spec random_dns_server() -> term().
random_dns_server() -> gen_server:call(?SERVER, random_dns_server).
